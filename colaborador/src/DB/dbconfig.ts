 ...
 **************************************************************************** */
export default {
  user: process.env.DB_DEV_USER_NAME_ARMARIO_ORACLE,
  password: process.env.DB_DEV_USER_PASSWORD_ARMARIO_ORACLE,
  connectString: process.env.DB_DEV_CONNECT_DESCRIPTOR_ARMARIO_ORACLE,
